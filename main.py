...
def get_arguments():
    parser = argparse.ArgumentParser(description='PyTorch semantic super-resolution')
    ...
    parser.add_argument('--factor', default=0.25, type=float)
    ...
    parser.add_argument('--use-tb', default=False, action='store_true')
